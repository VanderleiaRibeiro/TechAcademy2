...
(function () {
  ...
  if (missingFeatures.length === 0 && !isKasperskyScriptInjected) window["C3_Is_Supported"] = true;else {
    ...
    if (isKasperskyScriptInjected) msgTitle.textContent = "Kaspersky Internet Security broke this export";else msgTitle.textContent = "Software update needed";
    ...
    if (/android/i.test(ua)) msgText += '<br><br>On Android, fix this by making sure the <a href="https://play.google.com/store/apps/details?id=com.google.android.webview">Android System Webview</a> app has updates enabled and is up-to-date.';else if (/iphone|ipad|ipod/i.test(ua)) {
