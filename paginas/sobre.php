<div class="sobreG7">
  ...
  <div class="row g-0 bg-body-secondary position-relative">
    ...
    <h4><strong>Vanderléia Ribeiro</strong></h4> 
      ...
      <p>
        ...
        <br>Amante do mundo da Tecnologia.
  ...
  <div class="row g-0 bg-body-secondary position-relative">
    <div class="col-md-6 mb-md-0 p-md-4">
      <img src="imagens/elaine.jpeg" class="w-100" alt="Elaine">
    </div>
    <div class="col-md-6 p-4 ps-md-0">
      <h4><strong>Elaine Rafael</strong></h4>
      <h5 class="mt-0">Criadora de Walka</h5>
      <p>18 anos, mora atualmente em Iretama. Trabalha na area de suporte de t.i
        <br>Cursando TADS(Tecnologia em análise e desenvolvimento de sistemas), Centro Universitário Integrado
      </p>
      <p>
  ...
  <div class="row g-0 bg-body-secondary position-relative">
    <div class="col-md-6 mb-md-0 p-md-4">
      <img src="imagens/jack.jpeg" class="w-100" alt="Jack">
    </div>
    <div class="col-md-6 p-4 ps-md-0">
      <h4><strong>Jaqueline Custódio</strong></h4>
      <h5 class="mt-0">Criadora de Help Sauro</h5>
      <p>24 anos, mora atualmente em Campo Mourão.
        <br>Cursando TADS(Tecnologia em análise e desenvolvimento de sistemas), Centro Universitário Integrado.
        <br>Possui grande adeço por livros de ficção.
      </p>
      <p>
